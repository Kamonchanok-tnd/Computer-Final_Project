...
export default function Header() {
  ...
  return (
    <header className="mx-auto w-full max-w-screen-md px-4 sm:px-6 md:px-8 py-3 flex items-center justify-between">
      ...
      {/* หัวข้อ */}
      <h1 className="font-ibmthai text-xl sm:text-2xl font-semibold">
        วันนี้เป็นไงบ้าง
      </h1>

      {/* ปุ่มไปหน้า 'สรุปอารมณ์รายเดือน' */}
      <button
        type="button"
        onClick={() => navigate("/user/mirror/overview")} // เปลี่ยน path ให้ตรง route ของคุณ
