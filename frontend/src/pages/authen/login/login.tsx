...
//     <span className="text-4xl font-bold mb-4 text-center text-blue-300">SUT SUKJAI</span> 
//   </p>

//   {/* <h1 className="text-2xl font-bold mb-4 text-center text-blue-300">
//     เข้าสู่ระบบ
//   </h1> */}
...
//       <path d="M8 15 C10 17, 14 17, 16 15" stroke="#1976D2" strokeWidth="2" fill="none" />
...
//       <path d="M8 17 C10 15, 14 15, 16 17" stroke="#C2185B" strokeWidth="2" fill="none" />
...
//       <path d="M8 17 C10 15, 14 15, 16 17" stroke="#F57C00" strokeWidth="2" fill="none" />
...
//         จำฉันไว้ในระบบ
//       </label>
//       <button className="text-blue-900 hover:underline">ลืมรหัสผ่าน?</button>
//     </div>
...
//     ยังไม่มีบัญชี?{" "}
//     <button className="text-blue-900 hover:underline">สมัครสมาชิก</button>
//   </p>
// </div>
...
//           <h2 className="text-2xl font-bold mb-2 text-blue-300">ยินดีต้อนรับสู่ SUT SUKJAI! 👋</h2>
//           <p className="text-gray-500 max-w-md mx-auto">
//             เราให้บริการด้านสุขภาพจิตอย่างครบวงจร ทั้งการสนับสนุนด้านอารมณ์ การจัดการความเครียด และกิจกรรมส่งเสริมสุขภาพจิต เพื่อช่วยให้คุณมีความสุขและสมดุลในชีวิตประจำวัน
//           </p>
//         </div>
//       </div>
//     </div>
