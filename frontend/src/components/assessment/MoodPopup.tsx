...
const MoodPopup: React.FC = () => {
  ...
  const titleText = isAfterChat
    ? "พักจากแชทสักครู่ มาทำแบบคัดกรองกัน!"
    : "คุณเป็นยังไงบ้างช่วงนี้ ?";
  const descText = isAfterChat
    ? "แบบคัดกรองสั้น ๆ เพื่อเช็คอินอารมณ์หลังแชท"
    : "เรามีแบบคัดกรองสั้นๆ ที่ช่วยให้คุณรู้จักอารมณ์ และความรู้สึกของตัวเองมากขึ้น";
